...
public class WebLogAspects {
    ...
    private final GlobalExceptionHandlers exceptionHandle;


    private Log sysLog = null;

    private static final Logger LOGGER = LoggerFactory.getLogger(WebLogAspects.class);

    @Autowired
    public WebLogAspects(GlobalExceptionHandlers exceptionHandle) {
        this.exceptionHandle = exceptionHandle;
    }

    @Pointcut("@annotation(cn.qnm.annotation.SysLog)")
    public void webLog(){
